...
class TestIsValidEnv(unittest.TestCase):
    ...
    def test_required_arg_for_env(self):
        ...
        self.assertEqual(
            is_valid_env(expected_env, {"BACKUP_EVERY_N_DAYS": 25.5, **actual_env}),
            [
        ...
        self.assertEqual(
            is_valid_env(
                expected_env, {"BACKUP_EVERY_N_DAYS": "something", **actual_env}
            ),
            [
        ...
        self.assertEqual(
            is_valid_env(expected_env, {"BACKUP_EVERY_N_DAYS": 5, **actual_env}),
            True,
        )
